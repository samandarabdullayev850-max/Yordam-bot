...
def webhook():
    ...
    if "callback_query" in d:
        ...
        if data == "talaba":
            ...
            send(chat_id, "👩‍🏫 O'qituvchi bo'limi:", [[
            ...
            send(chat_id, "💼 Ofis xodimi bo'limi:", [[
            ...
            savollar = {
                ...
                "rezyume": "📄 Tajriba va ko'nikmalaringizni yozing:",
                ...
                "tavsif": "🏆 O'quvchi ismi va sababini yozing:",
                "reklama": "📱 Mahsulot yoki xizmat haqida yozing:",
                "biznes": "📊 Biznes g'oyangizni yozing:",
                "mahsulot": "🛍 Mahsulotingiz haqida yozing:",
                "email": "✉️ Kimga va nima haqida?"
            }
